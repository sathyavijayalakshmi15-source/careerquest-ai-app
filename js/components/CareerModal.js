      ...
      <div class="career-modal-backdrop open" id="careerDetailModalOverlay">
        <div class="glass-panel career-modal-box">
          ...
          <div class="modal-body flex flex-col gap-4">
            ...
            <!-- MAIN FOCUS: 3. CAREER PATHWAY (Full Width Stepper Card) -->
            <div class="modal-section-card highlight-pathway-card w-full">
              <h4 class="modal-section-title"><span>🗺️</span> 3. CAREER PATHWAY</h4>
              <p class="text-sm text-muted mb-4">Step-by-step roadmap from Class 12 to professional success:</p>
              ...
              <div class="career-timeline-wrapper">
                ...
                <div class="career-timeline-step">
                  ...
                  <div class="timeline-step-content">
                    ...
                    <p class="timeline-step-desc">Enroll in ${primaryDegreeText}. Build strong core domain fundamentals.</p>
                  </div>
                </div>
                ...
                <div class="career-timeline-step">
                  ...
                  <div class="timeline-step-content">
                    ...
                    <p class="timeline-step-desc">Pursue Master's degrees (M.Tech / M.Sc / MS / MBA) or specialized certifications.</p>
                  </div>
                </div>
                ...
                <div class="career-timeline-step">
                  ...
                  <div class="timeline-step-content">
                    ...
                    <p class="timeline-step-desc">Master key skills: ${primarySkillsText}. Build real-world projects and complete industry internships.</p>
                  </div>
                </div>
                ...
                <div class="career-timeline-step">
                  ...
                  <div class="timeline-step-content">
                    ...
                    <p class="timeline-step-desc">Enter industry as a Junior Specialist and advance to Senior & Leadership positions.</p>
                  </div>
                </div>
              </div>
            </div>

            <!-- BOTTOM GRID AREA: Degrees, Skills, Projects, Job Roles -->
            <div class="modal-bottom-grid">
              <!-- 4. Degree Pathways -->
              <div class="modal-section-card">
                <h4 class="modal-section-title"><span>📜</span> 4. Degree & Course Pathways</h4>
              ...
              <!-- 7. Possible Job Roles & Advancement -->
              <div class="modal-section-card">
                <h4 class="modal-section-title"><span>💼</span> 7. Possible Job Roles & Advancement</h4>
                <div class="chips-flex mt-2 mb-3">${jobRoleChips}</div>
                <h5 class="sub-label mt-3 mb-1">Stage Advancement:</h5>
                <ul class="why-appeared-list mt-1">${progressionList}</ul>
              </div>
            </div>
          </div>
